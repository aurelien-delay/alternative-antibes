...
export class ListecandidatsService {
  ...
  public getCandidats() {
    let output = [
      ...
      {numero:  7, hasphoto: true, prenom: "Jacques", nom: "de Montbron", age: 29, profession: "Ingénieur en informatique", phrase: "Parce qu'on aura +2°C dans 20 ans et qu'on part pour +7°C dans 80, il nous faut freiner à notre niveau cette future crise afin que les Antibois/-es, notamment les plus fragiles, aient un avenir vivable. Chaque année compte ! Et sur ces 6 prochaines courtes années, l'Alternative est la plus à même d'entreprendre ces urgents changements."},
      ...
      {numero: 25, hasphoto: true, prenom: "Sébastien", nom: "Roméro", age: 35, profession: "Infographiste", phrase: "Antibois depuis 36 ans, j'ai vu ma ville disparaître sous le béton, la pollution augmenter, la qualité de vie diminuer. J'ai vu également les inégalités et les injustices se creuser. Il est temps que les citoyens puissent reprendre le contrôle sur leur quotidien au lieu de subir la politique de la finance et des plus riches."},
      {numero: 26, hasphoto: false, prenom: "Michelle", nom: "Perrin", age: 72, profession: "Professeure des écoles retraitée", phrase: ""},
      {numero: 27, hasphoto: true, prenom: "Michel", nom: "Astre", age: 66, profession: "Directeur d’école maternelle retraité", phrase: "Pour qu'Antibes demeure, il nous faut davantage d'élus qui ont une conscience."},
      ...
      {numero: 33, hasphoto: false, prenom: "Jean-Pierre", nom: "Cochart", age: 71, profession: "Militant associatif dans l’aide\nà la recherche d’emploi et le logement", phrase: ""},
